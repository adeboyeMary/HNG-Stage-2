                ...
                <ul className="flex flex-row">
                    ...
                    {goods.map((goods) => (
                        ...
                        <div className="ml-4 w-[76px] lg:w-[6rem] lg:h-[6rem] rounded-[54%] lg:justify-between ">
                            <img src={goods.image} alt={goods.name} className="ml-[-5px] w-[6rem] lg:w-[7rem] lg:h-[7rem]
                            rounded-[50%] " />
                        </div>
                        <div><p className="text-center w-[6rem] lg:w-[7rem] mt-[1px] lg:mt-[1px] ">{goods.name} </p></div>
                        </li>
                    ))}
