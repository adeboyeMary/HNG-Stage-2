...
const CartProducts = () => {
    return (
        <div className="products flex flex-col text-black lg:flex lg:flex-row m-auto 
        lg:w-[63.49%] p-2">
                    ...
                    <div>
                        ...
                        <div className='flex flex-row justify-between'>
                            ...
                            <div className='flex flex-row space-x-2 text-[#807E7E] mt-[9px]'>
                                ...
                                justify-center border-[1px] text-[#807E7E] border-[#807E7E]'>-</button>
                                <span>1</span>
                                <button className='w-6 h-6 bg-transparent rounded-full flex items-center 
                                justify-center border-[1px] text-[#807E7E] border-[#807E7E]
                                hover:bg-[#E52659] hover:border-[#E52659]'>+</button>
                            </div>
                        </div>
                    </div>
                </div>
