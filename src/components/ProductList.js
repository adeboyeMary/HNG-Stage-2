            ...
            <HorizontalScroller>
                <ul className='bg-white w-[94.67%] mr-2 flex flex-row whitespace-normal gap-3 sm:gap-0 md:gap-0 lg:gap-4 '>
                    {products.map((product) => (
                        ...
                        md:h-[21.5rem] lg:h-[31rem] lg:break-normal flex flex-col lg:mb-[1rem] " >
                            {/* <div className=' lg:w-[100%] '> */}
                                    <div className="bg-[#F5F5F5] rounded-lg p-[0.7rem] sm:p-[0.7rem] md:p-[rem] lg:p-[0.7rem] ">
                                        <img  src={product.image} alt={product.name} className='w-[8rem] sm:w-[14rem]
                                         md:w-[9rem] md:h-[7rem] md:ml-[1rem]
                                    ...
                                    <div className='w-[10rem] sm:w-[18rem] md:w-[13rem] lg:w-[14rem] h-[10rem]   '>
                                        ...
                                        <div className="flex flex-row my-3 justify-between">
                                            ...
                                            <div className='flex flex-row'>
                                                <img src={star} alt='star' className='w-[10px] md:w-[1rem] h-[10px] mt-[1px]' />
                                                <p className='flex flex-row  ml-[6px] md:ml-[2.5px] text-[11px] '>{product.rating.rate}</p>
                                            </div>
